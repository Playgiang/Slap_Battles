...
if game.PlaceId == 6403373529 or game.PlaceId == 9015014224 then
local Window = OrionLib:MakeWindow({IntroText = "Slap Battles ðŸ‘", IntroIcon = "rbxassetid://15315284749",Name = ("<font color='#FF0000'>AmongUs </font> Ã— <font color='#f03929'>Giang Hub </font> - ".." Slap Battles ðŸ‘".." | ".. identifyexecutor()),IntroToggleIcon = "rbxassetid://7734091286", HidePremium = false, SaveConfig = false, IntroEnabled = true, ConfigFolder = "slap battles"})
...
Tab:AddParagraph("Zalo | Discord"," [ Zalo ]: Báº¡n muá»‘n vÃ o nhÃ³m Zalo thÃ¬ vÃ o Credit nhÃ© cÃ³ link nhÃ³m Zalo Ä‘Ã³ | [ Discord ]: If you want to join the Server hack slap battles group, go to the credits section ] | Good Luck")
...
for o = 1, #_G.GetPotion[AllGetPotion] do
if not game.Workspace:FindFirstChild(game.Players.LocalPlayer.Name.."'s Cauldron") then
game:GetService("ReplicatedStorage").GeneralAbility:FireServer()
end
for i = 1, #_G.GetPotion[AllGetPotion][_G.AutoPo] do
game.ReplicatedStorage:WaitForChild("AlchemistEvent"):FireServer(unpack({"AddItem", _G.GetPotion[AllGetPotion][_G.AutoPo][i]}))
game.ReplicatedStorage:WaitForChild("AlchemistEvent"):FireServer(unpack({"MixItem", _G.GetPotion[AllGetPotion][_G.AutoPo][i]}))
end
game.ReplicatedStorage:WaitForChild("AlchemistEvent"):FireServer(unpack({"BrewPotion"}))
...
if _G.SlapAuraChoose == "Reverse" then
for i,v in pairs(game.Players:GetChildren()) do
if v ~= game.Players.LocalPlayer and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and v.Character then
...
for i,v in pairs(game.Workspace:GetChildren()) do
                    if v.Name == "DEATHBARRIER" and v.Name == "DEATHBARRIER2" and v.Name == "dedBarrier" and v.Name == "ArenaBarrier" and v.Name == "AntiDefaultArena" then
                        v.CanTouch = false
                    end
                end
else
...
Tab15:AddParagraph("Share Link Zalo","Join Link Zalo Message All People Or Friend | Tham Gia Link Zalo Nháº¯n Tin Táº¥t Cáº£ Má»i NgÆ°á»i Hoáº·c Báº¡n BÃ¨")
Tab15:AddParagraph("Message Zalo","You Have To Message Zalo In VietNamese | Báº¡n Pháº£i Nháº¯n Tin Zalo Báº±ng Tiáº¿ng Viá»‡t")
Tab15:AddParagraph("Deputy Group Zalo","[ Táº¥n Lá»™c ( Owner ) ] or [ Giang ] or [ Tiáº¿n ] or [ HoÃ ng Kha ]")
Tab15:AddParagraph("Share Link Slap Battles Group","Join Link Zalo Message All People Or Friend | Tham Gia Link Zalo Nháº¯n Tin Táº¥t Cáº£ Má»i NgÆ°á»i Hoáº·c Báº¡n BÃ¨")
Tab15:AddParagraph("Message Slap Battles Group","You Have To Message Zalo In VietNamese Or English | Báº¡n Pháº£i Nháº¯n Tin Zalo Báº±ng Tiáº¿ng Viá»‡t hoáº·c Tiáº¿ng Anh")
...
local Window = OrionLib:MakeWindow({IntroText = (GameName), IntroIcon = "rbxassetid://15315284749",Name = ("<font color='#FF0000'>AmongUs </font> Ã— <font color='#f03929'>Giang Hub </font> - "..GameName.." / Server Elude"),IntroToggleIcon = "rbxassetid://7734091286", HidePremium = false, SaveConfig = false, IntroEnabled = true, ConfigFolder = "slap battles"})
...
local Window = OrionLib:MakeWindow({IntroIcon = "rbxassetid://15315284749",Name = ("<font color='#FF0000'>AmongUs </font> Ã— <font color='#f03929'>Giang Hub </font> - "..GameName.." | ".. identifyexecutor()),IntroToggleIcon = "rbxassetid://7734091286", HidePremium = false, SaveConfig = false, IntroEnabled = false, ConfigFolder = "slap battles"})
...
local Window = OrionLib:MakeWindow({IntroText = (GameName), Name = ("<font color='#FF0000'>AmongUs </font> Ã— <font color='#f03929'>Giang Hub </font> - "..GameName.." | ".. identifyexecutor()), HidePremium = false, SaveConfig = false, IntroEnabled = true, ConfigFolder = "slap battles"})
...
Tab1:AddLabel("Owner Credits Script By [ Giang ]")
Tab1:AddLabel("DonjoSx Shared Script Me, GoodLuck")
...
Badge2Group:AddDropdown("Farm Bob", {
    Text = "Farm Bob",
    Values = {"Auto Spawn E", "Auto Spawn", "Fast Spawn", "Normal","Super Fast Spawn"},
    Default = "Fast Spawn",
    Multi = false,
    Callback = function(Value)
Autobob = Value
...
Badge2Group:AddToggle("AutoFarm Bob", {
    Text = "AutoFarm Bob",
    Default = false, 
    Callback = function(Value) 
_G.AutoFarmBob = Value
...
Notification("You got Bob spawn", 5)
Toggles["AutoFarm Bob"]:SetValue(false)
end
task.wait(0.5)
end
while _G.AutoFarmBob and Autobob == "Auto Spawn" do
...
while _G.AutoFarmBob and Autobob == "Normal" do
if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("entered") == nil then
for i,v in pairs(game.Workspace.Lobby:GetChildren()) do
if v.Name == "Teleport1" then
if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") then
game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").WalkToPoint = v.Position
end
end
end
end
...
elseif _G.AutoFarmBob == true then
Notification("You don't have Replica equipped, or You have Owned Items", 5)
wait(0.05)
Toggles["AutoFarm Bob"]:SetValue(false)
end
    end
...
Badge2Group:AddDropdown("Farm Time", {
    Text = "Farm Time",
    Values = {"Voodoo + Fish", "MegaRock"},
    Default = "",
    Multi = false,
    Callback = function(Value)
AutoTime = Value
...
Badge2Group:AddToggle("AutoFarm Time", {
    Text = "AutoFarm Time",
    Default = false, 
    Callback = function(Value) 
_G.AutoTimeGet = Value
...
elseif AutoTime == "MegaRock" then
if game.Players.LocalPlayer.leaderstats.Glove.Value == "Diamond" and game.Players.LocalPlayer.Character:FindFirstChild("entered") then
game:GetService("ReplicatedStorage"):WaitForChild("Rockmode"):FireServer()
elseif _G.AutoTimeGet == true then
Notification("You don't have Diamond equipped, or You have go to arena", 5)
end
end
    end
})
