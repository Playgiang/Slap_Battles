...
local Window = OrionLib:MakeWindow({IntroText = "Slap Battles 👏", IntroIcon = "rbxassetid://15315284749",Name = ("RS Script - Slap Battles 👏".." | ".. identifyexecutor()),IntroToggleIcon = "rbxassetid://7734091286", HidePremium = false, SaveConfig = false, IntroEnabled = true, ConfigFolder = "slap battles"})
...
for i, v in pairs(Answer) do
        if Message:find(i) then
            OrionLib:MakeNotification({Name = "Error",Content = "Answer Question [ "..v.." ]",Image = "rbxassetid://7733658504",Time = 5})
            break
        end
    end
end
...
Tab15:AddParagraph("Share Link RS Script Group","Join Link Zalo Message All People Or Friend")
Tab15:AddParagraph("Message RS Script Group","You Have To Message English")

Tab15:AddButton({
	Name = "Copy Join RS Script Group",
	Callback = function()
            setclipboard("https://discord.gg/qjH5zwBf")
  	end    
})
...
local Window = OrionLib:MakeWindow({IntroText = (GameName), IntroIcon = "rbxassetid://15315284749",Name = ("RS Script - Killstreak Only"),IntroToggleIcon = "rbxassetid://7734091286", HidePremium = false, SaveConfig = false, IntroEnabled = true, ConfigFolder = "slap battles"})
...
local Window = OrionLib:MakeWindow({IntroText = (GameName), IntroIcon = "rbxassetid://15315284749",Name = ("RS Script - "..GameName.." / Server Elude"),IntroToggleIcon = "rbxassetid://7734091286", HidePremium = false, SaveConfig = false, IntroEnabled = true, ConfigFolder = "slap battles"})
...
local Window = OrionLib:MakeWindow({IntroIcon = "rbxassetid://15315284749",Name = ("RS Script - "..GameName.." | ".. identifyexecutor()),IntroToggleIcon = "rbxassetid://7734091286", HidePremium = false, SaveConfig = false, IntroEnabled = false, ConfigFolder = "slap battles"})
...
local Window = OrionLib:MakeWindow({IntroText = (GameName),IntroIcon = "rbxassetid://15315284749",Name = ("RS Script - "..GameName.." | ".. identifyexecutor()),IntroToggleIcon = "rbxassetid://7734091286", HidePremium = false, SaveConfig = false, IntroEnabled = true, ConfigFolder = "slap battles"})
...
local Window = OrionLib:MakeWindow({IntroText = (GameName), Name = ("RS Script - "..GameName.." | ".. identifyexecutor()), HidePremium = false, SaveConfig = false, IntroEnabled = true, ConfigFolder = "slap battles"})
