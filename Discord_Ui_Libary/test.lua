...
function DiscordLib:Window(text)
	...
	local newInsert = Instance.new("Frame")
newInsert.Name = "NewInsert"
newInsert.Parent = UserPanel
newInsert.BackgroundColor3 = Color3.fromRGB(54, 57, 63)
newInsert.Position = UDim2.new(0.0331491716, 0, 0.568140388, 100)
newInsert.Size = UDim2.new(0, 337, 0, 56)

local NewCorner = Instance.new("UICorner")
NewCorner.Parent = newInsert

local newName = Instance.new("TextLabel")
newName.Name = "NewUsernameText"
newName.Parent = newInsert
newName.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
newName.BackgroundTransparency = 1.000
newName.Position = UDim2.new(0.0419999994, 0, 0.154714286, 0)
newName.Size = UDim2.new(0, 65, 0, 19)
newName.Font = Enum.Font.GothamBold
newName.Text = "NEW USERNAME"
newName.TextColor3 = Color3.fromRGB(126, 130, 136)
newName.TextSize = 11.000
newName.TextXAlignment = Enum.TextXAlignment.Left

local newTag = Instance.new("TextLabel")
newTag.Name = "NewUserTag"
newTag.Parent = newInsert
newTag.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
newTag.BackgroundTransparency = 1.000
newTag.Position = UDim2.new(0.0419999994, 0, 0.493999988, 0)
newTag.Size = UDim2.new(0, 65, 0, 19)
